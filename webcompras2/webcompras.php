				...
				<article>
					...
					<div>
						<form name="formu" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
							...
							Portal Compras <br>
							<input type="radio" name="sel" value="rdc"> Registro de Clientes <br>
							<input type="radio" name="sel" value="l"> Login <br>
							<input type="radio" name="sel" value="cdpc"> Compra de Productos (Cliente)<br>
							<input type="radio" name="sel" value="cdpcf"> Cesta compra de Productos (Cliente)<br>
							<input type="radio" name="sel" value="cdcc"> Consulta de Compras (Cliente) <br><br>
